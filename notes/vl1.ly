...
KyrieViolinoI = {
  \relative c' {
    ...
    a'4.\p d8 \appoggiatura d cis4 e8 g,
    g4( f)\trill e8 r a d,
    ...
    a,4.\p d8 \appoggiatura d cis4 e8 g,
    \once \slurDashed g4( f)\trillE e8 r a d,
    es r fis r g r b4~
    ...
    b8. b16 a4 a'8. f,16 f8.\trill e32 f
    a'8. e,16 e8.\trill d32 e a'8. f,16 f8.\trill f'16
    f8\trill e r cis d d d, d %35
    es es fis fis g g b b
    b g f f f f e e
    d4 a'8\p d \appoggiatura d cis4 e8 g,
    g4( f)\trill e r
    r b''8\f b cis,4 d %40
    r2 g8 g f f
    e e d d f, f f f
    es es es es d\p d d d
    d4 e8 f cis2\trill
...
PanisVivusViolinoI = {
  \relative c' {
    ...
    c f e d c c b a a8\trill g r16 c( d e)
    ...
    a f c' a g4\trill f16 c\p-! d-! e-! f-! g-! a-! b-!
    c4. c8 \appoggiatura b a4 g8 r
    f4. f8 b8.( c32 d) c8 r
    d,16( f) f-! f-! d' f, d f c( f) f-! f-! c' f, c f %15
    b, f' f f b f b, f' a, f' f f a f a, f'
    d8 f f b \appoggiatura a g4 f8 c'
    c c b b a16( c)\f c c f c a c
    f,4 r8 a\p c c r c
    f h, r d c g r g %20
    ...
    d d d d d cis( d) e( f) d( cis) \once \slurDashed e( d) a( h cis)
    ...
    f4. f8 \appoggiatura es8 d4 r8 b'
    b[ b,] a r a r g r
    ...
    a4 r a'4. a8
    \appoggiatura g f4 e r r16 cis(\f d e) %65
    ...
    c a e' a, h4\trill a16 e\p fis gis a h c d
    e a( gis f!) e e e e e a( gis f!) e e e e
    e d( c h) a a a a a8 d c h
    ...
    \appoggiatura d cis4 r16 cis d a b( d) d-! d-! b' d, b d
    ...
    g g g g g r fis r
    g4.\f g8 \appoggiatura f es4 d8 r
    c'4. c8 \appoggiatura b! a4 g8 r
    f4. f8 \appoggiatura es d4 c8 r %125
    b'4. b8 \appoggiatura as g4 f8[ r16 b]
    \appoggiatura f8 es4 d8[ r16 b] b8\trill a! r4
    d,16 b' b b d\p b f b g es' es es d b a c
    d, b' b b d b f b g es' es es d b a c
    d, b' b b d b f b g b b b b d f b %130
    f, c' c c es c f, es' d b\f b b b f f f
    f4 r8 as\p as g r h
    c es r d \appoggiatura d c4 b8 d16 b
    g b b b g' b, g b f b b b f' b, f b
    es, b' b b es b es, b' d, b' b b d b f b %135
    ...
    es8.( f32 g) f4 r2
    R1
    f4.\f f8 \appoggiatura es d4 c8 r
...
ViaticumViolinoI = {
  \relative c' {
    ...
    r g r g' r f r a, %5
    r gis r gis r a r d
    r cis r e, e2\fermata \bar "||" %7 finis
  }
}
